    ...
    <>
      ...
      <div className="h-screen flex justify-center items-center">
        <div className="box-border h-1/2 w-1/2 border-4 rounded-2xl bg-yellow-100 border-black drop-shadow-[0_4px_0_rgb(0,0,0)]">
          ...
          <h1 className="text-5xl font-bold text-center pt-2">Password Strength Checker</h1>
          ...
          <form onSubmit={e => e.preventDefault()} className="flex justify-center items-center mt-8">
            ...
            />
            <input type="button" value="Clear" className="border-4 bg-white hover:bg-slate-200 rounded-2xl h-12 w-24 ml-2 border-black text-3xl font-semibold relative hover:-top-1" onClick={() => setNewPassword("")}/>
          </form>
